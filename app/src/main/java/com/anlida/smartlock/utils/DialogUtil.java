...
public class DialogUtil {
    ...
    public static AlertDialog showDialogunLock(Activity activity) {
        AlertDialog alertDialog = new AlertDialog.Builder(activity, AlertDialog.THEME_HOLO_DARK).create();
        alertDialog.show();
        // 获取布局
        final Window window = alertDialog.getWindow();
        ...
        tvConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showDialogunLockConfirm(activity);
            }
        });
        return alertDialog;
    }

    public static AlertDialog showDialogunLockConfirm(Activity activity) {
        AlertDialog alertDialog = new AlertDialog.Builder(activity, AlertDialog.THEME_HOLO_DARK).create();
        alertDialog.show();
        // 获取布局
        final Window window = alertDialog.getWindow();
