...
public class ClipView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (clipType == ClipType.CIRCLE) {
            ...
            //绘制中间的矩形
            canvas.drawRect(mHorizontalPadding, this.getHeight() / 2 - clipWidth / 3,
                    this.getWidth() - mHorizontalPadding, this.getHeight() / 2 + clipWidth / 3, paint);
            //绘制白色的矩形边框
            canvas.drawRect(mHorizontalPadding, this.getHeight() / 2 - clipWidth / 3,
                    this.getWidth() - mHorizontalPadding, this.getHeight() / 2 + clipWidth / 3, borderPaint);
        }
