package com.anlida.smartlock.zxing.view;
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			canvas.drawRect(frame.right - L_WIDTH, frame.top, frame.right,
					frame.bottom, paint);
			// 画扫描框边上的角，总共8个部分
			paint.setColor(Color.parseColor("#45AF2F"));
			...
			canvas.drawRect(frame.left + 80, slideTop - MIDDLE_LINE_WIDTH/2, frame.right - 80,slideTop + MIDDLE_LINE_WIDTH/2, paint);
...
//					null, lineRect, paint);
			...
			canvas.drawText(text, (width - textWidth)/2, (frame.bottom + (float)20 *density), paint);
...
//					frame.left,
//					(float) (frame.bottom + (float) 40 * density),
//					paint);
